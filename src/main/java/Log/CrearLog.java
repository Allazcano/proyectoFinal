...
public class CrearLog {
    ...
    public static void crearArchivoLog(String errorMensaje) {
        ...
        try {
            out = new BufferedWriter(new FileWriter("/errores/proyectoFinal/Log/"+ nombreArchivo, true));
    ...
    public static void doRutaMkdir() {
        if (!(new File("/errores/proyectoFinal/Log/").exists())) {
            (new File("/errores/proyectoFinal/Log/")).mkdirs();
        }}}
